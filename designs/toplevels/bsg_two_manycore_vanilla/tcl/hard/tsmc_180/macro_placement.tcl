...
proc bsg_place_macro { name x_origin y_origin orientation } {
...
proc bsg_place_manycore_tile_macros { prefix x_pos y_pos x_cord y_cord } {
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/imem_0/macro_mem"      [expr 2045 - 480 + $x_cord] [expr 1393 - 767 + $y_cord] E
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/bnkd_xbar/z_1__m1rw_mask/macro_mem" [expr 919 - 480 + $x_cord]  [expr 1410 - 767 + $y_cord] W
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/bnkd_xbar/z_0__m1rw_mask/macro_mem" [expr 918 - 480 + $x_cord]  [expr 790  - 767 + $y_cord] W

    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/rf_0/rf_mem/macro_mem0" [expr 1581 - 480 + $x_cord - 100] [expr 1350 - 767 + $y_cord] E
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/rf_0/rf_mem/macro_mem1" [expr 1581 - 480 + $x_cord - 100] [expr 1000 - 767 + $y_cord] E
}

proc bsg_place_manycore_tile_macros_mirror { prefix x_pos y_pos x_cord y_cord } {
    set tile_width 2000
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/imem_0/macro_mem"      [expr $tile_width -(2045 - 480) + $x_cord] [expr -594+1393 - 767 + $y_cord] W
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/bnkd_xbar/z_1__m1rw_mask/macro_mem" [expr $tile_width -(930 - 480) + $x_cord]  [expr 600+1410 - 767 + $y_cord] E
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/bnkd_xbar/z_0__m1rw_mask/macro_mem" [expr $tile_width -(930 - 480) + $x_cord]  [expr 600+790  - 767 + $y_cord] E

    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/rf_0/rf_mem/macro_mem0" [expr $tile_width -(1581 - 480) + $x_cord + 100] [expr -200+1350 - 767 + $y_cord] W
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/rf_0/rf_mem/macro_mem1" [expr $tile_width -(1581 - 480) + $x_cord + 100] [expr -200+1000 - 767 + $y_cord] W
}


proc bsg_place_manycore_tile_macros_square { prefix x_pos y_pos x_cord y_cord } {
    set tile_width 2000
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/vanilla_core/imem_0/macro_mem"      [expr $tile_width -(2045 - 480) + $x_cord ] [expr -594+1393 - 767 + $y_cord +590] N
#    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/bnkd_xbar/z_1__m1rw_mask/macro_mem" [expr $tile_width -(930 - 480) + $x_cord]  [expr 600+1410 - 767 + $y_cord] E
    bsg_place_macro "${prefix}/y_${y_pos}__x_${x_pos}__proc/h_z/bnkd_xbar/z_0__m1rw_mask/macro_mem" [expr $tile_width -(930 - 480) + $x_cord - 510]  [expr 600+790  - 767 + $y_cord ] N
...
if {$xDim==1} {
    ...
    bsg_place_macro "g/n_0__clnt_clnt/l2f/bct/bcti/b1_ntf/rof_1__psdlrg_fifo/big1p/mem_1srw/macro_mem" 2618 754 E
} else {
    ...
    bsg_place_macro "g/n_0__clnt_clnt/l2f/bct/bcti/b1_ntf/rof_2__psdlrg_fifo/big1p/mem_1srw/macro_mem" 2918 754 E
    bsg_place_macro "g/n_0__clnt_clnt/l2f/bct/bcti/b1_ntf/rof_3__psdlrg_fifo/big1p/mem_1srw/macro_mem" 3218 754 E
