# TSMC_16 customization for bsg_two_manycore_vanilla
#
...
set asic_hard_filelist [join "
  ...
  $bsg_ip_cores_dir/hard/tsmc_16/bsg_mem/bsg_mem_1rw_sync_mask_write_byte.v
  $bsg_ip_cores_dir/hard/tsmc_16/bsg_mem/bsg_mem_1rw_sync.v
  $bsg_ip_cores_dir/hard/tsmc_16/bsg_mem/bsg_mem_2r1w_sync.v
"]
